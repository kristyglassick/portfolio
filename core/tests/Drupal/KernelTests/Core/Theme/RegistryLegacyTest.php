...
class RegistryLegacyTest extends KernelTestBase {
  ...
  public function testMultipleSubThemes() {
    $this->expectDeprecation('Unsilenced deprecation: Theme functions are deprecated in drupal:8.0.0 and are removed from drupal:10.0.0. Use Twig 04-templates instead of theme_theme_test(). See https://www.drupal.org/node/1831138');
  ...
  public function testSuggestionPreprocessFunctions() {
    $this->expectDeprecation('Unsilenced deprecation: Theme functions are deprecated in drupal:8.0.0 and are removed from drupal:10.0.0. Use Twig 04-templates instead of test_legacy_theme_theme_test_preprocess_suggestions__kitten__meerkat(). See https://www.drupal.org/node/1831138');
    $theme_handler = \Drupal::service('theme_handler');
